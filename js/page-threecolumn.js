$(function() {
    ...
    //左侧JS
    rxued.table.LChangeapart($("#tab1 tr"), "#eee", "#fff");
    ...
    //点击信息员显示弹框
    threeLayerShow(".project-clickDiv",".project-alert");
    //显示四段弹框
    fourLayerShow(".xiangmu-clickDiv",".xiangmu-alert");
  //显示列表大弹框
...
function threeLayerShow(clickClass,alertClass,fn) {
    $(clickClass).on("click",function(){
        ...
        $(clickClass).addClass("anItemBor-active");
